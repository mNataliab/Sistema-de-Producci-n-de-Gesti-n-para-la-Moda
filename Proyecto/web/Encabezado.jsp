                    ...
                    <div class="nav-header pull-left">
                        <div class="logo-wrap">
                            <a href="index.html">
                                ...
                                <span class="brand-text">SPGM</span>
                                <span class="brand-text" style="font-size: 15px;"><%= cargo%></span>
                ...
                <div id="mobile_only_nav" class="mobile-only-nav pull-right">
                    <ul class="nav navbar-right top-nav pull-right">
                        ...
                        <li class="dropdown auth-drp">
                            <a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown"><img src="dist/img/usuario.PNG" alt="user_auth" class="user-auth-img img-circle"/><span class="user-online-status"></span></a>
                            <ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                                <li>
                                    <a href="DatosUsuario.jsp"><i class="zmdi zmdi-account"></i><span>Mi Perfil</span></a>
                                </li>

                                <li>
                                    <a href="ContraseñaUsuario.jsp"><i class="zmdi zmdi-settings"></i><span>Cambiar Contraseña</span></a>
                                </li>
                                <li class="divider"></li>

                                <li class="divider"></li>
                                <li>
                                    <a href="loginprueba?action=cerrar_sesion"><i class="zmdi zmdi-power"></i><span>Salir</span></a>
                                </li>
                            </ul>
                        </li>
                    </ul>
