    ...
    <div class="container-fluid">
        <div class="row heading-bg">
            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                <h5 class="txt-dark">Registrar Ingreso</h5>
            </div>
        </div>
        <div class="panel panel-default card-view">
            <div class="row">
                <div class="col-md-12">
                    <div class="form-wrap">
                        <form data-toggle="validator" role="form" action="ControllerIngreso?action=create" method="post">
                            ...
                            <div class="form-group" style="width: 360px">
                                <label for="inputDescripcion" name="observacion" class="control-label mb-10">Observación</label>
