...
<html lang="en">
    ...
    <!-- Mirrored from hencework.com/theme/flintstone/full-width-light/form-validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 02 Nov 2017 05:18:58 GMT -->
    <head>
        <meta charset="UTF-8" />
                                                                ...
                                                                <a href="javascript:void(0)">
                                                                    <div class="chat-data">
                                                                        ...
                                                                        <div class="user-data">
                                                                            ...
                                                                            <span class="time block truncate txt-grey">Unityength</span>
                                                                        </div>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default card-view">
                                <div class="panel-heading">
                                    <div class="pull-left">
                                        <h6 class="panel-title txt-dark">Editar Uusuario</h6>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="panel-wrapper collapse in">
                                    <div class="panel-body">
                                        <% Usuario editarnh = (Usuario) request.getAttribute("usuarioss");%>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-wrap">
                                                    <form method="Post" action="UsuarioController?action=update&id=<%=editarnh.getIdUsuario()%>" data-toggle="validator" action="UsuarioController?action=update&id=<%= editarnh.getIdUsuario() %>"  >
                                                        <div class="form-group">
                                                            <label for="inputName" class="control-label mb-10">Nombre</label>
                                                            <input type="text" class="form-control" name="nombre" id="inputName" placeholder="nombre"  value="<%= editarnh.getNombre() %>"  required>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="inputName" class="control-label mb-10">Apellido</label>
                                                            <input type="text" class="form-control" name="apellido" id="inputApellido" placeholder="apelllio" value="<%= editarnh.getApellido() %>"  required>
                                                        </div>
                                                        <div class="form-group ">
                                                            <label for="inputTwitter" class="control-label mb-10">Documento</label>
                                                            <input type="number"  class="form-control" name="documento" id="inputDocumento" placeholder="documento" value="<%= editarnh.getDocumento() %>"  required maxlength="11"> 

                                                        </div>

                                                        <div class="form-group ">
                                                            <label for="inputTwitter" class="control-label mb-10">Teléfono</label>
                                                            <input type="number"  class="form-control"  name="telefono" id="inputTelefono" placeholder="telefono" value="<%= editarnh.getTelefono() %>"  required maxlength="11">

                                                        </div>

                                                        <div class="form-group">
                                                            <label for="inputEmail" class="control-label mb-10">Email</label>
                                                            <input type="email" class="form-control" name="email" id="inputEmail" placeholder="email" data-error="Por favor, ingrese un correo @misena.edu.co"  value="<%= editarnh.getCorreo() %>"  required>
                                                        ...
                                                        <div class="form-group" hidden="">
                                                            ...
                                                            <div class="row">
                                                                <div class="form-group col-sm-12">
                                                                    <input type="password" data-minlength="6" class="form-control" name="contrasena" id="inputContrasena" value="<%= editarnh.getContrasena() %>" placeholder="Contrasena" >
                                                        ...
                                                        <div class="form-group">
                                                            <div class="radio">
                                                                <input type="radio" <% if (editarnh.getCargo().equals("Administrador")) { out.print("checked"); } %> value="Administrador" name="underwear"    id="box" required>
                                                                <label for="box"> Administrador</label>
                                                            </div>
                                                            <div class="radio">
                                                                <input type="radio" <% if (editarnh.getCargo().equals("Instructor")) { out.print("checked"); } %>  value="Instructor" name="underwear"   id="bri" required>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="radio">
                                                                ...
                                                                <input type="radio" <% if (editarnh.getEstado().equals("Activo")) { out.print("checked"); } %> value="Activo" name="derwear"  id="box" required>
                                                                <label for="box"> Activo</label>

                                                            </div>
                                                            <div class="radio">
                                                                <input type="radio" <% if (editarnh.getEstado().equals("Inactivo")) { out.print("checked"); } %> value="Inactivo" name="derwear"   id="bri" required>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="radio">
                                                                <input type="radio" <% if (editarnh.getGenero().equals("Femenino")) { out.print("checked"); } %> value="Femenino" name="nderwear" id="box" required>
                                                                <label for="box"> Femenino</label>
                                                            </div>
                                                            <div class="radio">
                                                                <input type="radio" <% if (editarnh.getGenero().equals("Masculino")) { out.print("checked"); } %> value="Masculino" name="nderwear"   id="bri" required>
                                                                <label for="bri"> Masculino </label>
                                                            </div>
                                                        </div>

                                                        <div class="form-group mb-0">
                                                            <button type="submit" class="btn btn-success btn-anim"><i class="icon-rocket"></i><span class="btn-text">Actualizar</span></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
