                ...
                <div class="col-md-6">
                    <div class="panel panel-default card-view">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-dark">Registrar Nuevo Tipo</h6>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="form-wrap">
                                            ...
                                            <form data-toggle="validator" role="form" action="Ctpm?action=create" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="idmaterial">
                                                        <option value="">Seleccione</option>

                                                        <c:forEach var="material" items="${requestScope.Arraymaterial}">
                                                            <option selected="selected" value="${material.idMaterial}">${material.nombre}</option>
                                                        </c:forEach>
                                                ...
                                                <div class="form-group mb-0">
                                                    ...
                                                    <br>
                                                    <button style="bottom: 40px; left: 240px;" type="submit" class="btn btn-success btn-anim" onclick="location.href = 'CTipoProducto?action=estado&id=<%= Integer.parseInt(request.getParameter("id"))%>'" ><i class="icon-rocket"></i><span class="btn-text">Finalizar Tipo Producto</span></button>
                                                    ...
                                                    <c:forEach var="productos" items="${requestScope.listatproducto}">
                                                        <tr> 
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="form-group mb-0">
                                                                    <button class="btn btn-info btn-icon-anim btn-square" title="Eliminar" onclick="location.href = 'Ctpm?action=eliminar&id=${productos.tipoProductoYMaterial}'"><i class="icon-trash"></i></button>
                                                                </div>
