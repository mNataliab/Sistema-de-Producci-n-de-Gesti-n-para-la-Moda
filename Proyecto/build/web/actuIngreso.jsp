                ...
                <div class="container-fluid">
                    <div class="row heading-bg">
                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            <h5 class="txt-dark">Editar INGRESO</h5>
                        </div>
                    </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-sm-12 col-xs-12">
                                                <div class="form-wrap">
                                                    <% Ingreso sActualizar =(Ingreso) request.getAttribute("ingreso"); %>
                                                    <h2> Actualizar Ingreso  </h2>            				
                                                    <form method="post" action="ControllerIngreso?action=actualizar&id=<%=sActualizar.getIdIngreso()%>">
                                                        ...
                                                        <div class="form-group">
                                                            <label class="control-label mb-10" for="exampleInputuname_1">Observación</label>
                                                            <div class="input-group">
                                                                <div class="input-group-addon"><i class="icon-user"></i></div>
                                                                <input type="text" class="form-control"  name="Observacion" id="Observacion" value="<%=sActualizar.getObservacion()%>">
                                                            </div>
                                                        </div>   
