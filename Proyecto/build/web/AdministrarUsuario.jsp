                ...
                <div class="col-sm-12">
                    <div class="panel panel-default card-view">
                        <div class="panel-heading">
                            <div class="pull-left">
                                <h6 class="panel-title txt-dark">Listar Usuario</h6>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <p class="text-muted">Administrar <code>Usuario</code> </p>
                                <div class="table-wrap mt-40">
                                    <div class="table-responsive">
                                        <table id="datatable-buttons" id="footable_3" class="table" data-filtering="true"  data-show-toggle="false">
                                            ...
                                            <c:forEach var="p" items="${requestScope.LISTAR}">
                                                <tr>
                                                    <th><c:out value="${p.nombre}" /></th>
                                                    <th><c:out value="${p.apellido}" /></th>
                                                    <th><c:out value="${p.documento}" /></th>
                                                    <th><c:out value="${p.telefono}" /></th>
                                                    <th><c:out value="${p.correo}" /></th>

                                                    <th><c:out value="${p.cargo}" /></th>
                                                    <th>
                                                        <button class="btn btn-default btn-icon-anim btn-square" title="Editar" onclick="location.href = 'UsuarioController?action=update&id=${p.idUsuario}'"><i class="fa fa-pencil"></i></button>
